...
# directory 
dirP <- "E:/Google Drive/research/projects/utica/model_save/2017/prediction_128/valid"
#directory for orig img
dirI <- "E:/Google Drive/research/projects/utica/model_save/2017/data_128/valid_out"
