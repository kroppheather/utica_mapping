...
# directory 
dirP <- "E:/Google Drive/research/projects/utica/model_save/1950/model_kernal/prediction/valid"
#directory for orig img
dirI <- "E:/Google Drive/research/projects/utica/model_save/1950//model_kernal/prediction/crop_valid"
