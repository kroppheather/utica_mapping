...
# directory 
dirP <- "E:/Google Drive/research/projects/utica/model_save/1950/prediction_strat3/valid"
#directory for orig img
dirI <- "E:/Google Drive/research/projects/utica/model_save/1950/prediction_strat3/crop_valid"
