...
# directory 
dirP <- "E:/Google Drive/research/projects/utica/model_save/1980/prediction_strat/valid"
#directory for orig img
dirI <- "E:/Google Drive/research/projects/utica/model_save/1980/prediction_strat/crop_valid"
