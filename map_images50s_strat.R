...
dirO <- c("/Volumes/GoogleDrive/My Drive/research/projects/utica/model_save/1950/data_strat/image")
#directory for masks
dirM <- c("/Volumes/GoogleDrive/My Drive/research/projects/utica/model_save/1950/data_strat/mask")
...
bound_poly <- st_read("/Volumes/GoogleDrive/My Drive/research/projects/utica/strat/bound_strat_50.shp")
bound_polyPr <- st_transform(bound_poly, st_crs(r50s))
#create ID field
bound_polyPr$Loc <- as.factor(bound_polyPr$ID)
...
# save data, commented out since does not need to run every time
    ...
    #                                 dfSubA$colID[i], 
    #                                 dfSubA$colID[i]+127)), 
    #             paste0("/Volumes/GoogleDrive/My Drive/research/projects/utica/model_save/1950/data_strat/image/train_",i,".tif"),
...
imgN <- raster(paste0("/Volumes/GoogleDrive/My Drive/research/projects/utica/model_save/1950/data_strat/image/train_",trainNum,".tif"))
