...
dirO <- c("e:/Google Drive/research/projects/utica/model_save/1950/data_strat2/image")
#directory for masks
dirM <- c("e:/Google Drive/research/projects/utica/model_save/1950/data_strat2/mask")
...
# save data, commented out since does not need to run every time
     ...
     #                                 dfSubA$colID[i], 
     #                                 dfSubA$colID[i]+127)), 
     #             paste0("e:/Google Drive/research/projects/utica/model_save/1950/data_strat2/image/train_",i,".tif"),
...
imgN <- raster(paste0("e:/Google Drive/research/projects/utica/model_save/1950/data_strat2/image/train_",trainNum,".tif"))
