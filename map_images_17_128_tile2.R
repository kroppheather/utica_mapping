...
dir256 <- "E:/Google Drive/research/projects/utica/model_save/2017/img_tile_256/image_2"
...
writeRaster(imgT1, paste0(dirI[dirN], "/image_2/predict_", ((1*4)-3), ".tif"), 
            format="GTiff")
writeRaster(imgT2, paste0(dirI[dirN], "/image_2/predict_", ((1*4)-2), ".tif"), 
            format="GTiff")
writeRaster(imgT3, paste0(dirI[dirN], "/image_2/predict_", ((1*4)-1), ".tif"), 
            format="GTiff")
writeRaster(imgT4, paste0(dirI[dirN], "/image_2/predict_", ((1*4)), ".tif"), 
            format="GTiff")
...
for(i in 2:Nimg){
  ...
  writeRaster(imgT1, paste0(dirI[dirN], "/image_2/predict_", ((i*4)-3), ".tif"), 
              format="GTiff")
  writeRaster(imgT2, paste0(dirI[dirN], "/image_2/predict_", ((i*4)-2), ".tif"), 
              format="GTiff")
  writeRaster(imgT3, paste0(dirI[dirN], "/image_2/predict_", ((i*4)-1), ".tif"), 
              format="GTiff")
  writeRaster(imgT4, paste0(dirI[dirN], "/image_2/predict_", ((i*4)), ".tif"), 
              format="GTiff")
