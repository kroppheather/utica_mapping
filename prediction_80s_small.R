...
dirP <- "E:/Google Drive/research/projects/utica/model_save/1980/prediction_128/image"
dirI <- "E:/Google Drive/research/projects/utica/model_save/1980/img_tile_128/image"
...
dirP2 <- "E:/Google Drive/research/projects/utica/model_save/1980/prediction_128/image_2"
dirI2 <- "E:/Google Drive/research/projects/utica/model_save/1980/img_tile_128/image_2"
...
dirP3 <- "E:/Google Drive/research/projects/utica/model_save/1980/prediction_128/image_3"
dirI3 <- "E:/Google Drive/research/projects/utica/model_save/1980/img_tile_128/image_3"
...
treeMap <- calc(treeLayer,function(x){ifelse(x <= 0.35, 0, x)})
buildMap <- calc(buildLayer,function(x){ifelse(x <= 0.25, 0, x)})
paveMap <- calc(paveLayer,function(x){ifelse(x <= 0.15, 0, x)})


# binary map of above

treeMapB <- calc(treeLayer,function(x){ifelse(x <= 0.35, 0, 1)})
buildMapB <- calc(buildLayer,function(x){ifelse(x <= 0.25, 0, 1)})
...
png("E:/Google Drive/research/projects/utica/model_save/1980/maps_128/utica_classification.png", width=8448,height=4992)

plot(origAll, col=grey(1:100/100), axes=FALSE, legend=FALSE, box=FALSE, maxpixels= 8448*4992)
...
writeRaster(uticaRes, "E:/Google Drive/research/projects/utica/model_save/1980/all_maps/utica80s_128.tif", format="GTiff" )
