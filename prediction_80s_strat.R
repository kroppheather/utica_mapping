...
dirP <- "E:/Google Drive/research/projects/utica/model_save/1980/prediction_strat/image"
...
dirP2 <- "E:/Google Drive/research/projects/utica/model_save/1980/prediction_strat/image_2"
...
dirP3 <- "E:/Google Drive/research/projects/utica/model_save/1980/prediction_strat/image_3"
...
buildMap <- calc(buildLayer,function(x){ifelse(x <= 0.3, 0, x)})
...
buildMapB <- calc(buildLayer,function(x){ifelse(x <= 0.3, 0, 1)})
...
writeRaster(uticaClass, "E:/Google Drive/research/projects/utica/model_save/1980/all_maps/utica80s_strat.tif", format="GTiff" )
